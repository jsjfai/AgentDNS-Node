---
title: 'Docker Setup'
description: 'Deploy AIAgentDNS·DNSNode using Docker and Docker Compose'
---

# Docker Setup

This guide covers deploying AIAgentDNS·DNSNode using Docker, including development and production configurations.
...
This Docker setup provides a complete containerized environment for AIAgentDNS·DNSNode with development and production configurations.
