...
description: 'Configure Nginx as a reverse proxy for AIAgentDNS·DNSNode'
---

# Nginx Configuration

This guide explains how to configure Nginx as a reverse proxy for AIAgentDNS·DNSNode, including SSL termination, load balancing, and caching strategies.
...
For high-availability setups with multiple AIAgentDNS·DNSNode instances:
...
When running AIAgentDNS·DNSNode in Docker, update the proxy configuration:
...
**502 Bad Gateway**: Check if AIAgentDNS·DNSNode is running and accessible
...
# Check if AIAgentDNS·DNSNode is responding
...
This configuration provides a solid foundation for running AIAgentDNS·DNSNode behind Nginx with proper security, performance, and reliability features.
