...
description: 'Monitor your MCP servers and analyze system logs with AIAgentDNS·DNSNode'
---

## Overview

AIAgentDNS·DNSNode provides comprehensive monitoring and logging capabilities to help you track server performance, debug issues, and maintain system health.

## Real-time Monitoring

### Server Status Dashboard

The AIAgentDNS·DNSNode dashboard provides real-time monitoring of all registered MCP servers:
...
AIAgentDNS·DNSNode supports standard log levels:
...
AIAgentDNS·DNSNode uses structured logging for better analysis:
...
AIAgentDNS·DNSNode collects various system metrics:
...
Import AIAgentDNS·DNSNode Grafana dashboard:

```json
{
  "dashboard": {
    "title": "AIAgentDNS·DNSNode Monitoring",
    "panels": [
      {
        "title": "Server Status",
        "type": "stat",
