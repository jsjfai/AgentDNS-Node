...
Before installing AIAgentDNS·DNSNode, ensure you have the following prerequisites:
...
<Tabs>
  <Tab title="Docker (Recommended)">
    ...
    Docker is the recommended way to deploy AIAgentDNS·DNSNode in production.
  ...
  <Tab title="npm Package">
    ...
    Install AIAgentDNS·DNSNode as a global npm package:
    ...
    You can also install AIAgentDNS·DNSNode locally in a project:
    ...
    # Install AIAgentDNS·DNSNode locally
  ...
  <Tab title="Kubernetes">
    ...
    Deploy AIAgentDNS·DNSNode on Kubernetes with these manifests:
...
After installation, verify AIAgentDNS·DNSNode is working:
...
<AccordionGroup>
  ...
  <Accordion title="Network Issues">
    **Can't access dashboard:**
    - Check if AIAgentDNS·DNSNode is running: `ps aux | grep mcphub`
    ...
    **AI clients can't connect:**
    ...
    - Check if AIAgentDNS·DNSNode is behind a proxy
