---
title: AIAgentDNS·DNSNode Documentation
...
Get AIAgentDNS·DNSNode running in minutes with Docker:
...
AIAgentDNS·DNSNode provides multiple ways to access your MCP servers:
...
<CardGroup cols={2}>
  <Card title="Quick Start Guide" icon="rocket" href="/quickstart">
    Get AIAgentDNS·DNSNode running in 5 minutes
  </Card>
