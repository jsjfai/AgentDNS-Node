---
title: 'Markdown 语法'
description: 'AIAgentDNS·DNSNode 文档的 Markdown 编写指南和最佳实践'
---

## 标题

在 AIAgentDNS·DNSNode 文档中，每个页面应该只使用一个 `#` 标题，它会自动成为页面标题。
...
AIAgentDNS·DNSNode 文档支持标准的 Markdown 文本格式：
