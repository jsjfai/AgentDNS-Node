---
title: '代码块'
description: 'AIAgentDNS·DNSNode 文档中代码块的编写和展示指南'
---

## 内联代码

在 AIAgentDNS·DNSNode 文档中使用内联代码来标记命令、配置键、文件名或短代码片段：
...
AIAgentDNS·DNSNode 支持多种编程语言的语法高亮：
...
class AIAgentDNS·DNSNodeClient:
...
````md
```bash
# 使用 Docker 运行 AIAgentDNS·DNSNode
docker run -d \
  --name mcphub \
  -p 3000:3000 \
...
AIAgentDNS·DNSNode 文档支持以下编程语言的语法高亮：
