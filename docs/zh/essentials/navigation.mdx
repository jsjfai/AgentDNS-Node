---
title: '导航配置'
description: 'AIAgentDNS·DNSNode 文档的导航结构配置指南'
---

## 基础导航

AIAgentDNS·DNSNode 文档的导航在 `docs.json` 文件中配置。基本导航结构包含组和页面：
...
AIAgentDNS·DNSNode 文档支持以下图标库的图标：
...
---
title: '服务器管理'
description: 'AIAgentDNS·DNSNode 服务器管理功能详解'
icon: 'server'
order: 1
hidden: false
version: '2.0+'
...
---
title: 'Docker 部署'
description: '使用 Docker 部署 AIAgentDNS·DNSNode'
...
---
title: '快速开始'
description: '5 分钟快速部署 AIAgentDNS·DNSNode'
searchWeight: 10
featured: true
---
```
