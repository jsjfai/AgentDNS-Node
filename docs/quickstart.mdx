...
description: 'Get AIAgentDNS·DNSNode running in 5 minutes'
---
...
<Tabs>
  <Tab title="Docker (Recommended)">
    The fastest way to get started with AIAgentDNS·DNSNode is using Docker:
  ...
  <Tab title="npm Package">
    Install AIAgentDNS·DNSNode as a global package:
...
Once your servers are configured, connect your AI clients using AIAgentDNS·DNSNode endpoints:
...
<AccordionGroup>
  <Accordion title="Server won't start">
    ...
    correctly set - Check AIAgentDNS·DNSNode logs for detailed error messages
  </Accordion>

  <Accordion title="Can't connect from AI client">
    - Ensure AIAgentDNS·DNSNode is running on the correct port - Check firewall settings - Verify the endpoint
    URL format
  </Accordion>
