FROM registry.cn-jssz1.ctyun.cn/aidev/python:3.13-slim-bookworm AS base
...
RUN uv tool install --index-url https://mirrors.aliyun.com/pypi/simple/ mcp-server-fetch
